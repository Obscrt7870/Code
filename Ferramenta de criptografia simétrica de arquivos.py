...
if name == "main": op, inf, outf, pwd = sys.argv[1:5] # ex: python novacrypt.py encrypt fin.xlsx fin.novacrypt "V3rao@2024!" (encrypt if op == "encrypt" else decrypt)(inf, outf, pwd)